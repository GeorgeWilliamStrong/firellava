...
if __name__ == "__main__":
    ...
    # Dataset
    ################
    dataset_name = sft_script_args.dataset_name
    try:
        raw_datasets = load_dataset(dataset_name)
        print("Dataset loaded successfully with load_dataset.")
    except Exception as e:
        print(f"Failed to load dataset with load_dataset: {e}")
        try:
            raw_datasets = load_from_disk(dataset_name)
            print("Dataset loaded successfully with load_from_disk.")
        except Exception as e:
            print(f"Failed to load dataset with load_from_disk: {e}")
            raise RuntimeError("Failed to load dataset with both methods.") from e
